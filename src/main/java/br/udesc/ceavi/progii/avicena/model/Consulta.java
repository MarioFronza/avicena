...
public class Consulta {
    ...
    private NurseEntity enfermeiro;
    ...
    public NurseEntity getEnfermeiro() {
        return enfermeiro;
    }

    public void setEnfermeiro(NurseEntity enfermeiro) {
        this.enfermeiro = enfermeiro;
    }
    ...
    public String toString() {
        return "Consulta{" + "codigo=" + codigo + ", data=" + data + ", hora=" + hora + ", sintomas=" + sintomas
                + ", paciente=" + paciente + ", enfermeiro=" + enfermeiro + ", medico=" + medico + ", estadoPaciente="
                + estadoPaciente + '}';
    }
}
