...
public class FrameSistema extends JFrame {
    ...
    public FrameSistema() {
        ...
        super.setIconImage(Toolkit.getDefaultToolkit()
                .getImage(getClass().getResource("/br.udesc.ceavi.progii.avicena.view.image/logo.png")));
        // Nome da aplicação
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSistema.class.getName())
    ...
    private void initalizeDesktopPane() {
        ...
        ImageIcon referencia = new ImageIcon(
                getClass().getResource("/br.udesc.ceavi.progii.avicena.view.image/Avicena2.jpg")); // chama a imagem
