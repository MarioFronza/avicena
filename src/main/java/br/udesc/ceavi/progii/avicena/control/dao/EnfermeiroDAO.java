...
public class EnfermeiroDAO implements DAO<Enfermeiro> {
    ...
    public boolean inserir(Enfermeiro obj) throws ValorNuloException {
        if (obj.getNome().isEmpty()) throw new ValorNuloException("Nome do enfermeiro em aberto");
        ...
        if (obj.getFormacao().isEmpty()) throw new ValorNuloException("Formação em aberto");
