...
public class ListenerCRUDDiagnostico {
    ...
    public ListenerCRUDDiagnostico(
            DiagnosticoPrimario diagnosticoPrimario, DiagnosticoFinal diagnosticoFinal, FrameCRUD tela) {
    ...
    private class btExcluirActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            int resposta = JOptionPane.showConfirmDialog(
                    tela,
                    "Deseja exluir este Diagnóstico final?",
                    "Confirmar Exclusão",
                    JOptionPane.YES_NO_OPTION,
                    JOptionPane.QUESTION_MESSAGE);
            if (resposta == JOptionPane.YES_OPTION) {
    ...
    private class btGravarActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            diagnosticoPrimario.setTemperatura(
                    Integer.parseInt(frame.getTfTemperatura().getText()));
